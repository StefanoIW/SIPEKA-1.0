    ...
    <div class="container mt-4">
        ...
        <table class="table table-bordered">
            <tr>
                ...
                <th>Jabatan</th>
                <th>Tahun Mulai Tugas</th>
                <th>Opsi</th>
            </tr>
            <?php 
            include 'koneksi.php';
            $no = 1;
            $data = mysqli_query($koneksi, "SELECT * FROM tabel_karyawan WHERE jabatan='guru'");
            ...
            <tr>
                ...
                <td>
                    <a href="page_ubah_peg_admin.php?id=<?php echo $d['id']; ?>"><button class="btn btn-success">EDIT</button></a>
                    <a href="proses_hapus_admin.php?id=<?php echo $d['id']; ?>"><button class="btn btn-danger">HAPUS</button></a>
                </td>
            </tr>
            <?php 
            }
