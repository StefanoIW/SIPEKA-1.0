...
<ul class="nav navbar-nav">
    ...
    <form action="proses_upload_4d.php" method="post" enctype="multipart/form-data">
     ...
     <label for="tahun_penilaian">Tahun penilaian:</label>
      <input type="number" id="tahun_penilaian" name="tahun_penilaian" value="<?php echo $tahun_ini; ?>" readonly >
            ...
            <h3>D. Tim Pengembang Institusi </h3>
            
            <div>
                <label for="ivd1">1. Guru dapat berperan dalam pengembangan institusi Nusaputera secara luas.
Surat tugas / SK ditandatangani oleh Manajemen. </label>
               
                <select name="ivd1" id="ivd1">
                    <option></option>
                    <option>Tidak pernah</option>
                    <option >Anggota</option>
                    <option >Panitia inti (Ketua,sekretaris,bendahara,koordinator )/penugasan personal( fasilitator, koordinator : e-commerce, digital marketing, dan yg setara )</option>
                </select>
                <div class="form-group">
        <label for="berkasivd1" style="text-decoration: underline;"> Surat tugas personal /SK Kepanitiaan yang ditandatangani oleh  Manajemen:</label>
        <input type="file" id="berkasivd1" name="berkasivd1" >
    </div>

    <div class="form-group" style="display: none;">
        <label for="berkasivd11">Berkas 2:</label>
        <input type="file" id="berkasivd11" name="berkasivd11">
    </div>

    <!-- Add file input for berkasiaaa1 -->
    <div class="form-group" style="display: none;">
        <label for="berkasivd111">Berkas 3:</label>
        <input type="file" id="berkasivd111" name="berkasivd111" >
    </div>
