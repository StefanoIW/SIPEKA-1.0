...
<div class="navbar-guru" id="navbar-guru">
    ...
    <form action="proses_upload_4.php" method="post" enctype="multipart/form-data">
     ...
     <label for="tahun_penilaian">Tahun penilaian:</label>
      <input type="number" id="tahun_penilaian" name="tahun_penilaian" min="2023" max="2030" >
          ...
          <label>  1. Guru dapat dilibatkan sebagai mitra dalam melayani transaksi yang tersedia, maupun sebagai pengguna aplikasi dengan berpartisipasi membeli produk yang ditawarkan.</label>
                ...
                <div class="form-group">
        <label for="berkasive1" style="text-decoration: underline;">Screenshot aplikasi dari hp:</label>
        <input type="file" id="berkasive1" name="berkasive1" >
    </div>

    <div class="form-group" style="display: none;">
        <label for="berkasive11"> surat kemitraan :</label>
...
<label for="ivea1">    • Sebagai Mitra</label>
               ...
               <div class="form-group">
       <label for="berkasivea1" style="text-decoration: underline;">Surat Kemitraan:</label>
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   var form = document.querySelector('form');
   form.addEventListener('submit', function(event) {
       if (ivea1.value !== 'Tidak pernah' && (berkasivea1.value === '')) {
           event.preventDefault(); // Prevent form submission
           alert('Mohon isi semua berkas di bagianGuru dapat dilibatkan sebagai mitra dalam melayani transaksi yang tersedia, maupun sebagai pengguna aplikasi dengan berpartisipasi membeli produk yang ditawarkan');
       }
   });
